...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Samir Sharma</title>
            <meta name="description" content="Explore articles authored by Samir Sharma, a Full Stack Engineer and Developer." />
