...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Samir Sharma</title>
            ...
            <meta name="keywords" content="500, internal server error, Samir Sharma, Portfolio,broken link ,missing page,link not found" />
