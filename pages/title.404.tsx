...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Samir Sharma</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Samir Sharma, Portfolio,broken link ,missing page,link not found" />
